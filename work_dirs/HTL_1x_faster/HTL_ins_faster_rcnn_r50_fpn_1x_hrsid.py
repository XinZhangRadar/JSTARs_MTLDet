model = dict(
    ...
    roi_head=dict(
        type='HybridTaskLearningInstanceCascadeRoIHead',
        num_stages=1,
        interleaved=False,
        ...
        bbox_head=[
            dict(
                ...
                loss_cls=dict(
                    ...
                    branch='cls',
                    loss_weight='auto2'),
                loss_bbox=dict(type='SmoothL1Loss', beta=1.0, loss_weight='auto2', branch='bbox',))
        ],
        ...
        edge_head=dict(
            ...
            num_classes=1,
            ignore_label=255),
        denisity_mask_pred_head=dict(
            type='HTLDenisityHead',
            with_conv_res=False,
            num_convs=0,
            in_channels=256,
            conv_out_channels=256,
...
work_dir = '/share/home/zhangxin/mmdetection/work_dirs/HRSID/loss_abstudy/auto_weight2/'
